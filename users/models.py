...
class Profile(models.Model):
    ...
    stock_folio = models.ManyToManyField(Portfolio,
                                         through='ProfilePortfolioJunction')  # #   a profile can have multiple portfolio
...
class ProfilePortfolioJunction(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        return super(ProfilePortfolioJunction, self).save(*args, **kwargs)
